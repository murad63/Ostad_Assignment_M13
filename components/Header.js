...
const Header = () => {
  ...
  const [color, setColor] = useState("#41F8A0"); //transparent
  ...
  return (
    <div
      ...
      className="fixed left-0 top-0 w-full z-20 ease-in duration-300 bg-[#3a40ef] py-1 shadow-md shadow-black/5 dark:bg-neutral-600 dark:shadow-black/10"
    >
